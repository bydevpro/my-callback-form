...
<div class="form-container sign-up-container">
    ...
    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholer="Ваше Имя" required autocomplete="name">


    <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Ваш e-mail') }}</label>
    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholer="Ваш e-mail" required autocomplete="email">


    <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Придумайте пароль') }}</label>
    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholer="Ваш пароль" required autocomplete="new-password">
    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholer="Повторите Ваш пароль" required autocomplete="new-password">
